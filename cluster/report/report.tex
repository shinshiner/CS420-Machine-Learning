...
I generate 3 clusters on the three corners of a triangle, reducing the distance among them and visualizing the model selection results as Sec. \ref{sec:1}.
