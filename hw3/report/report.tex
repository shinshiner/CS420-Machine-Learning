...
In some cases, the performance of a classification model might be reduced due to the redundant features in dataset. Therefore, I test the performance of SVM under different variance radios of features (Fig. \ref{fig:svm-dim}).
...
This result indicates both of \textit{splice} and \textit{satimage} have few redundant features and less features 
