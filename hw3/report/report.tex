...
In this section, I would show the process of finetuning my SVM model. Due to the limited computer resources, I can hardly conduct comprehensive experiments. I tend to focus on the points I think is important.
...
As is shown in the above table, linear kernel achieves best performance, polynomial kernel is the next one and sigmoid kernel owns the worst performance.

\paragraph{2. Parameters of Polynomial Kernel}

Since polynomial kernel has similar performance with linear kernel, and there exist few parameters in linear kernel, I tend to adjust the degree of polynomial kernel to obtain better performance.
